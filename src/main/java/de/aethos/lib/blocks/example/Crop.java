...
public class Crop extends AbstractCustomBlock {
    public Crop(BlockType<? extends AbstractCustomBlock> type, CustomBlockData data) {
        super(type, data);
    }
    ...
    public static class TestCrop implements BlockType<Crop> {
        @Override
        ...
        @Override
        public CustomBlockFactory<Crop> factory() {
            return Crop::new;
        }
        ...
        public NamespacedKey key() {
            return new NamespacedKey(plugin(), "crop");
        }
        ...
        public Option<DisplayEntityData> display() {
            return Option.some(DisplayEntityData.display(Material.WHEAT, 1, Rotation.ONE));
        }

        @Override
        public ItemData itemData() {
            return new ItemData(Material.WHEAT, 1, Component.text("Pflanze"), new NamespacedKey(plugin(), "crop"), meta -> {
            });
        }
